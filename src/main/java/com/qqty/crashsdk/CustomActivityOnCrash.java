...
public final class CustomActivityOnCrash {
    ...
    private static final String EXTRA_CONFIG = "com.qqty.crashsdk.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "com.qqty.crashsdk.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "com.qqty.crashsdk.EXTRA_ACTIVITY_LOG";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.qqty.crashsdk.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.qqty.crashsdk.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.qqty.crashsdk";
    ...
    public static void install(@Nullable final Context context) {
        try {
            if (context == null) {
                ...
                Log.i(TAG, "异常捕获框架已安装,(Crash has been installed.)");
            }
        } catch (Throwable t) {
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.qqty.crashsdk.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.qqty.crashsdk.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.qqty.crashsdk.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.qqty.crashsdk.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
